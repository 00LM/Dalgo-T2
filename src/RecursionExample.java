...
public class RecursionExample {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("#####DIVIDE AND CONQUER: UNSORTED");
		...
		if(posDC>=0) System.out.println("Position of value "+value+" in unsorted list. Divide and conquer: "+posDC+". Value in numbers "+numbers.get(posDC));
		...
		if(posDC>=0) System.out.println("Position of value "+value+" in sorted list. Divide and conquer: "+posDC+". Value in numbers "+numbers.get(posDC));
	}
